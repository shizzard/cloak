-module(cloak_generate_i_new_optional).
...
i_new_optional__() ->
    [?es:function(?es:atom(?cloak_generated_function_i_new_optional), i_new_optional_clauses__())].


i_new_optional_clauses__() ->
    [
        ?es:clause(i_new_optional_clause_patterns_return__(), _Guards = none, i_new_optional_clause_body_return__()),
        ?es:clause(i_new_optional_clause_patterns_iterate__(), _Guards = none, i_new_optional_clause_body_iterate__())
    ].


i_new_optional_clause_patterns_return__() ->
    [?es:underscore(), cloak_generate:var__(record, 0), ?es:list([])].


i_new_optional_clause_body_return__() ->
    [cloak_generate:var__(record, 0)].


i_new_optional_clause_patterns_iterate__() ->
...
i_new_optional_clause_body_iterate__() ->
    [?es:case_expr(i_new_optional_clause_body_iterate_case_argument__(), i_new_optional_clause_body_iterate_case_clauses__())].


i_new_optional_clause_body_iterate_case_argument__() ->
    ?es:tuple([
        ?es:application(
...
i_new_optional_clause_body_iterate_case_clauses__() ->
    [
        ?es:clause(
            i_new_optional_clause_body_iterate_case_clause_patterns_keytrue__(),
            _Guards = none,
            i_new_optional_clause_body_iterate_case_clause_body_keytrue__()
        ),
        ?es:clause(
            i_new_optional_clause_body_iterate_case_clause_patterns_binkeytrue__(),
            _Guards = none,
            i_new_optional_clause_body_iterate_case_clause_body_binkeytrue__()
        ),
        ?es:clause(
            i_new_optional_clause_body_iterate_case_clause_patterns_false__(),
            _Guards = none,
            i_new_optional_clause_body_iterate_case_clause_body_false__()
        )
    ].
...
i_new_optional_clause_body_iterate_case_clause_body_keytrue__() ->
    ...
    [?es:application(
        ?es:atom(?cloak_generated_function_i_new_optional),
